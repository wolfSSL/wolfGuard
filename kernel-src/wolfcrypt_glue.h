...
/* backward compat */
#if defined(WC_DRBG_BANKREF) && defined(WC_RNG_BANK_SUPPORT) && !defined(WC_HAVE_RNG_BANKREF)
    #define WC_HAVE_RNG_BANKREF
#endif

#if (defined(WC_HAVE_RNG_BANKREF) || \
     (defined(WC_RNG_HAVE_RBGC) && \
      (defined(HAVE_WC_RNG_BANK) || defined(WC_RNG_BANK_SUPPORT)))) && \
